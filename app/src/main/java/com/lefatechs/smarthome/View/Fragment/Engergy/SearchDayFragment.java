...
public class SearchDayFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.item_energy_day, container, false);

        searchButton=view.findViewById(R.id.button_itemEnergyDay_GetData);
        spDay = view.findViewById(R.id.spinner_itemEnergyDay_Day);
        spMonth = view.findViewById(R.id.spinner_itemEnergyDay_Month);
        spYear = view.findViewById(R.id.spinner_itemEnergyDay_Year);

        ArrayAdapter<String> spAdapterDay = new ArrayAdapter<String>(
                getActivity(),R.layout.item_spinner,mDays
        );

        spAdapterDay.setDropDownViewResource(R.layout.item_spinner);
        spDay.setAdapter(spAdapterDay);

        ArrayAdapter<String> spAdapterMonth = new ArrayAdapter<String>(
                getActivity(),R.layout.item_spinner,mMonths
        );

        spAdapterMonth.setDropDownViewResource(R.layout.item_spinner);
    ...
    public void UpdateEnergyChart(){
        ValueFormatter xAxisFormatter = new HourAxisValueFormatter(ElectricChartFragment.chart);
        ...
        setData(24,100, ElectricChartFragment.chart);
        ElectricChartFragment.chart.invalidate();
    }

    public void UpdateWaterChart(){
        ValueFormatter xAxisFormatter = new HourAxisValueFormatter(WaterChartFragment.chart);
        ...
        setData(24,80, WaterChartFragment.chart);
