...
import com.lefatechs.smarthome.Custom.DayAxisValueFormatter;
...
public class SearchMonthFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.item_energy_month, container, false);

        searchButton=view.findViewById(R.id.button_itemEnergyMonth_GetData);
        spMonth = view.findViewById(R.id.spinner_itemEnergyMonth_Month);
        spYear = view.findViewById(R.id.spinner_itemEnergyMonth_Year);
    ...
    public void UpdateEnergyChart(){
        ValueFormatter xAxisFormatter = new DayAxisValueFormatter(ElectricChartFragment.chart);
        ...
        setData(31,3000, ElectricChartFragment.chart);
        ElectricChartFragment.chart.invalidate();
    }

    public void UpdateWaterChart(){
        ValueFormatter xAxisFormatter = new DayAxisValueFormatter(WaterChartFragment.chart);
        ...
        setData(31,2400, WaterChartFragment.chart);
